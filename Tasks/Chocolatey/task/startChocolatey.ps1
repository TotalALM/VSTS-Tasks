...
$user.SetInfo()
$user.description = "vsts task installer"
$user.SetInfo()
...
Invoke-Command -FilePath $command -Credential $credential -ComputerName $env:COMPUTERNAME -ArgumentList $packages
